...
class ServiceTypeController extends Controller
{
    ...
    public function store(StoreRequest $request)
    {
        ...
        $this->Duplicate($service_type, $request);
    ...
    public function update(UpdateRequest $request, ServiceType $serviceType): \Illuminate\Http\RedirectResponse
    {
        ...
        $this->Duplicate($serviceType, $request);
     ...
     * @return void
     */
    public function Duplicate(ServiceType $service_type, StoreRequest $request): void
    {
        $service_type->save();
